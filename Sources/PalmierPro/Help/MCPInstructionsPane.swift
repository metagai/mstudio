    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: AppTheme.Spacing.xxl) {
                Text(L10n.string("Connect an external agent to inspect and edit the open \(AppIdentity.name) project. The server listens on this Mac only and requires the access token below."))
                ...
                SettingsGroup(title: L10n.string("Access token")) {
                    tokenSection
                }
