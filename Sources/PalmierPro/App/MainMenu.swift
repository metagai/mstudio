...
enum MainMenuBuilder {
    ...
    private static func appMenu() -> NSMenuItem {
        ...
        menu.addItem(withTitle: L10n.string("About \(AppIdentity.name)"), action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: L10n.string("Quit \(AppIdentity.name)"), action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        item.submenu = menu
        return item
    }
