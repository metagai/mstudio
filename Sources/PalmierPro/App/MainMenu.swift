...
enum MainMenuBuilder {
    ...
    private static func appMenu() -> NSMenuItem {
        ...
        menu.addItem(withTitle: "About METAG", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: "")
        ...
        menu.addItem(.separator())
        menu.addItem(withTitle: "Quit METAG", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        item.submenu = menu
        return item
    }
